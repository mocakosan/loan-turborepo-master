...
import { deleteLoanNews } from "@/actions/admin/delete-loan-news";
import { createLoanNews } from "@/actions/admin/create-loan-news";

type Props = {
  loanNewsList: GetLoanNewsList["loanNewsList"];
  meta: GetLoanNewsList["meta"];
};

export default function LoanNews({ loanNewsList, meta }: Props) {
  ...
  const handleSearch = () => {
    router.push(`/loan-news?q=${searchQuery}&page=1`);
  };
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl font-bold text-gray-900">대부업 소식</h1>
        ...
        <Pagination>
          <PaginationContent>
            <PaginationItem>
              <PaginationPrevious
                onClick={() => {
                  router.push(`/loan-news?page=${meta?.previousPage || 1}`);
                }}
                className={
                  meta?.currentPage === 1
              ...
              return Array.from({ length: endPage - startPage + 1 }, (_, i) => {
                ...
                return (
                  <PaginationItem key={pageNum}>
                    <PaginationLink
                      onClick={() => {
                        router.push(`/loan-news?page=${pageNum}`);
                      }}
            ...
            <PaginationItem>
              <PaginationNext
                onClick={() => {
                  router.push(`/loan-news?page=${meta?.nextPage || 1}`);
                }}
                className={
